...
public class NGDownloadImage {
     ...
     * @param img   传入图片
     */
    public void addTask(String url, NGNormalCircleImageView img) {
        //添加任务
        ...
        if (bitmap != null) {
            ...
            if (callback != null) {
                ...
                //如果没有，则直接设置该图片为bitmap
                    ((NGNormalCircleImageView) img).setImageBitmap(bitmap);
            ...
            synchronized (taskMap) {
                ...
                for (View view : collection) {
                    ...
                    if (view != null) {
                        ...
                        String url = "";
                        //通过判断是否属于mode或者NGNormalCircleImageView来获得相应的tag中存储的url
