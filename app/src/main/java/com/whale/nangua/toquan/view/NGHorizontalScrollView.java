 ...
 */
public class NGHorizontalScrollView extends HorizontalScrollView implements View.OnTouchListener{
     ...
     * @param attrs
     */
    public NGHorizontalScrollView(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    private static Handler handler = new Handler() {
        public void handleMessage(android.os.Message msg) {
            NGHorizontalScrollView myScrollView = (NGHorizontalScrollView) msg.obj;
